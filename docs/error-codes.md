...
|--------|----------------|------------------|
| 0 | Successful | تراکنش موفق است |
| 1 | failure | ناموفق |
| 2 | Transaction status is unknown | وضعیت تراکنش نامشخص است |
...
| 13001 | Malformed token | توکن نامعتبر است |
| 13002 | Invalid token | توکن نامعتبر است |
...
| 13008 | Token is expired | توکن منقضی شده است |
...
| 13025 | Transaction status is unsuccessful | تراکنش ناموفق است |
| 13026 | Invalid Pan | شماره کارت نامعتبر است |
| 13027 | Mobile number and Pan are not match | شماره موبایل برای شماره کارت وارد شده نیست |
| 13028 | Callback domain is not valid | آدرس کالبک نامعتبر است |
| 13029 | Transaction status is confirmed | تراکنش موفق و تایید شده است |
| 13030 | Transaction before is verified and its failed | تراکنش تایید شده و ناموفق است |
| 13031 | Transaction is not yet verified | تراکنش منتظر تایید است |
| 13032 | Expired card | کارت منقضی شده است |
| 13033 | Transaction status is reversed | وضعیت تراکنش اصلاحیه است (بازگشت وجه انجام شده است) |
| 13034 | A successful verify has been received for the desired transaction | Verify موفق بوده و تاییدیه در زمان مقرر ایجاد خواهد شد |
| 13045 | Card holder canceled transaction | دارنده کارت تراکنش را لغو کرد |
| 13046 | Already setteled | تراکنش تسویه شده است |
...
| 13073 | Inactive account | حساب غیر فعال است |
| 13074 | cardBlock by terminal | کارت توسط ترمینال مسدود شد |
| 13075 | Confirm time expired | زمان تاییدیه منقضی شده است |
| 13076 | Reverse time expire | زمان اصلاحیه منقضی شده است |
| 13077 | Invalid original transaction | تراکنش اصلی نامعتبر است |
| 13078 | Enter Card Pin | رمز کارت وارد گردد |
...
| 13085 | Host down destination bank | میزبان بانک مقصد در دسترس نیست |
...
| 13089 | Banned transaction with contact interface | تراکنش با واسط غیرتماسی مردود شد |
| 13090 | End work day | پایان روز کاری |
| 13091 | Switch is inactive | سوئیچ غیر فعال است |
| 13092 | There is no way to send transaction | صادرکننده کارت نامعتبر |
...
| 13307 | Card or pin timeout | مهلت زمانی کارت یا پین به پایان رسیده است |
...
| 13318 | Invalid company code | کد سازمان ناموجود |
| 13319 | EOF | سیستم با اختلال همراه است |
| 13320 | Card suspected fraud | کارت نامعتبر است |
| 13321 | Terminal additional not found | اطلاعات تکمیلی پایانه موجود نیست |
| 13322 | OTP reached max retry | درخواست رمز پویا بیش از حد مجاز |
...
| 13332 | PSP is not supported By shaparak | توسط شاپرک پشتیبانی نمی‌شود |
| 13333 | Card suspected fraud card block by terminal | کارت نامعتبر است |
| 13334 | Wrong entry pin is over limit | ورود پین بیش از حد مجاز |
...
| 13340 | CardHolder Account Status Is Bad | کارت یا حساب مبدا در وضعیت نامناسب است |
| 13341 | Terminal Account Status Is Bad | کارت یا حساب مقصد در وضعیت نامناسب است |
...
| 13364 | Incorrect hot bill type | نوع وصول آنی نامعتبر است |
...
| 13383 | Not found settlement action | عملیات تسویه یافت نشد |
...
| 13417 | NotImplemented | عملیات پیاده‌سازی نشده است |
| 13418 | InvalidTransactionRequestTime | خطا در تاریخ درخواست |
| 13419 | InvalidLogonTransactionTime | خطا در زمان ورود |
| 13420 | InvalidReference | شماره مرجع نامعتبر |
| 13421 | TransactionIsComplete | تراکنش به اتمام رسید |
| 13422 | ResponseInvalidIP | آی‌پی پذیرنده معتبر نیست |
| 13423 | ResponseIllegalTransaction | تراکنش مجاز نیست |
| 13424 | InvalidFacilitatorMessage | پیام پرداخت‌یار مجاز نیست |
| 13425 | ProviderError | خطا از سمت تامین‌کننده |
| 13426 | Transaction Status Must Be Confirmed | وضعیت تراکنش تایید نشده است |
| 13427 | Invalid Authorization | دسترسی غیرمجاز |
| 13428 | Already Verified | تاییدیه قبلاً ارسال شده است |
| 13429 | Authorization Failed | احراز هویت موفق نبود |
| 13430 | Authorization Failed, Try Again Later | احراز هویت موفق نبود — بعداً تلاش کنید |
